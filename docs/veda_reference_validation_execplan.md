...
- [x] (2026-05-18) Reapplied the GAP 3 harness on top of current `main` after GAP 2 analytical B-matrix was merged, without reverting GAP 2 files.
...
Reapply-on-current-main validation outcome:
